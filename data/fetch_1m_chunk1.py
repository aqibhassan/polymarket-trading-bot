"""Fetch BTCUSDT 1-minute klines from Binance: Nov 8 - Nov 23, 2025."""
...
OUTPUT = "data/btc_1m_chunk1.csv"

# Date range in milliseconds
START_MS = int(datetime(2025, 11, 8, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
END_MS = int(datetime(2025, 11, 23, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
