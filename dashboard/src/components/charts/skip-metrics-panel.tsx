...
const REASON_COLORS: Record<string, string> = {
  ...
  momentum_veto: '#ef4444',           // red
  clob_stability_skip: '#f97316',     // orange
  coin_flip_zone_skip: '#eab308',     // yellow
  calibration_skip_no_edge: '#6366f1', // indigo
  desert_skip_paper: '#71717a',       // gray
  fak_no_real_ask_to_cross: '#8b5cf6', // violet
};
